      ...
      <header className="bg-white text-slate-800 shadow-sm sticky top-0 z-50 border-b">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center space-x-6 text-base">
            ...
            {user && <Link className="hover:text-green-600 transition-colors" to="/resultats">Résultats</Link>}
          </nav>
            ...
            {user ? (
               <div className="relative group">
                    ...
                    <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-20 hidden group-hover:block">
                        <Link to="/dashboard" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Mon Profil</Link>
